...
<head>
  ...
  <title>Галактика для любимой</title>
...
<div class="pill">Я так сильно тебя люблю, моя принцеса💛</div>
<div class="attribution">Base: tlanex · Adaptación para Jotab 💫</div>
<div id="err" class="error"></div>

<div class="player">
  <button id="playBtn">▶︎</button>
  <span style="font-size:12px;opacity:.9">Выбери свою любимую <b>музыку.mp3</b> <b>💙🌹♥️</b> (люблю тебя💕)</span>
  <input type="file" id="pickFile" accept="audio/*">
  <button id="pickBtn">Выбрать песню</button>
...
playBtn.onclick = async () => {
  ...
  catch(e){ showError('Если файл не воспроизводиться, нажмите “Выбрать песню” и выберите MP3.'); }
};
...
} catch(e) { showError('WebGL Похоже отключён. Попробуйте Chrome/Edge/Firefox, или включите аппаратное ускорение.'); return; }
...
const phrases = ["Принцесса ✨", " Прекрасная 💛", "Моя зайка", "Моя душа 🌌", "Красотка ✨", "Моя бессконечность ♾️", "Моё всё", "Я от тебя без ума 🥰", " Алина 💫", "Я тебя люблю💛", "Мой любимый голосочек  🎶", "Уникальная 😊", "Моя королева 👑", "Любовь моя", "Мой мир", "Моя звёздочка 🌠", "Моя Девочка", "Моё сокровище💛", "Моё счастье", "Моя любимая", "Моя мечта", "Моя нежная", "Моя малышка", "Моя богиня", "Я люблю тебя бесконечно ♾️"];
